...
### **SearchParameterPushHistoryByTid**

SearchParameterPushHistoryByTid API allow the third party system to find all the terminal push history of parameter
application by tid
...
| pageSize    | int        | false    | the record number per page, range is 1 to 100                |
| packageName | String     | false    | search filter by app packageName                             |
| tid         | String     | false    | only terminal with specified tid will search out             |
| pushStatus  | PushStatus | true     | the push status  the value can be PushStatus.Success, PushStatus.Failed |
| pushTime    | Date       | true     | search the push history after the push time                  |
...
```
PushHistoryApi pushHistoryApi = new PushHistoryApi("https://api.whatspos.com/p-market-api", "RCA9MDH6YN3WSSGPW6TJ", "TUNLDZVZECHNKZ4FW07XFCKN2W0N8ZDEA5ENKZYN");
Result<ParameterPushHistoryDTO> result = pushHistoryApi.searchParameterPushHistoryByTid(1, 2,  "com.pax.android.demoapp", "1170000652", PushHistoryApi.PushStatus.Success, StringUtils.parseDateTime("2019-11-20 00:00:00"));
```
  ...
  "dataset": [
    {
      ...
      "pushType": "Terminal",
      "parameterVariables": "{\"#{test}\": \"44\"}",
      "parameterValues": "{\"sys_F2_sys_param_termId\": \"#{test}\", \"sys_F2_sys_param_merCode\": \"000000000000001\", \"sys_F2_sys_param_merName\": \"Union Pay\", \"sys_F2_sys_param_acqInsCode\": \"000000000000000\"}",
      "appPushError": null
    },
    {
      "parameterPushStatus": "Success",
...
### **SearchLatestParameterPushHistoryByTid**

SearchLatestParameterPushHistoryByTid API allow the third party system to find all the terminal latest push history of
parameter application by tid
...
```
PushHistoryApi pushHistoryApi = new PushHistoryApi("https://api.whatspos.com/p-market-api", "RCA9MDH6YN3WSSGPW6TJ", "TUNLDZVZECHNKZ4FW07XFCKN2W0N8ZDEA5ENKZYN");
Result<ParameterPushHistoryDTO> result = pushHistoryApi.searchLatestParameterPushHistoryByTid(1, 2,  "com.pax.android.demoapp", "1170000652", PushHistoryApi.PushStatus.Success, StringUtils.parseDateTime("2019-11-20 00:00:00"));
```
...
### **SearchOptimizedParameterPushHistoryByTid**

SearchOptimizedParameterPushHistoryByTid API allow the third party system to find all the optimized terminal push
history of parameter application by tid
...
```
PushHistoryApi pushHistoryApi = new PushHistoryApi("https://api.whatspos.com/p-market-api", "RCA9MDH6YN3WSSGPW6TJ", "TUNLDZVZECHNKZ4FW07XFCKN2W0N8ZDEA5ENKZYN");
Result<OptimizedParameterPushHistoryDTO> result = pushHistoryApi.searchOptimizedParameterPushHistoryByTid(1, 2,  "com.pax.android.demoapp", "1170000652", PushHistoryApi.PushStatus.Success, StringUtils.parseDateTime("2019-11-20 00:00:00"));
```
  ...
  "dataset": [
    {
      ...
      "serialNo": "1170000652",
      "pushType": "Terminal",
      "parameters": "{\"sys.param.termId\": \"44\", \"sys.param.merCode\": \"000000000000001\", \"sys.param.merName\": \"Union Pay\", \"sys.param.acqInsCode\": \"000000000000000\"}",
      "appPushError": null
    },
    {
      "parameterPushStatus": "Success",
...
### **SearchLatestOptimizedParameterPushHistoryByTid**

SearchLatestOptimizedParameterPushHistoryByTid API allow the third party system to find all the optimized terminal push
history of parameter application by tid
...
```
PushHistoryApi pushHistoryApi = new PushHistoryApi("https://api.whatspos.com/p-market-api", "RCA9MDH6YN3WSSGPW6TJ", "TUNLDZVZECHNKZ4FW07XFCKN2W0N8ZDEA5ENKZYN");
Result<OptimizedParameterPushHistoryDTO> result = pushHistoryApi.searchLatestOptimizedParameterPushHistoryByTid(1, 2,  "com.pax.android.demoapp", "1170000652", PushHistoryApi.PushStatus.Success, StringUtils.parseDateTime("2019-11-20 00:00:00"));
```
