# PAXSTORE Open API Java SDK [ ![Download](https://api.bintray.com/packages/paxstore-support/paxstore/paxstore-3rd-app-android-sdk/images/download.svg?version=6.0.2) ](https://bintray.com/paxstore-support/paxstore/paxstore-openapi-java-sdk/6.0.2)
